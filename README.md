# Available .IRISH One-Word Domains (9,351)
...
Daily-updated dataset of available and resale .irish one-word domains from Unique Domains.

> **Note:** this repository currently mirrors the full live catalog for this exact search.
> Unique Domains counts can still change as the search refreshes.

**Public extract:** 9,351 rows · **Live catalog:** 9,351 domains
...
| ----------------------- | ------------------------------------------------ |
| 9,351-row public sample | 9,351 live domains                               |
...
> Unique Domains. *Available .IRISH One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
