# Available .IRISH One-Word Domains (9,352)
...
> **Important:** this repository is a **public 9,351-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **9,352 domains** on the canonical page below.

**Public extract:** 9,351 rows · **Live catalog:** 9,352 domains
...
- `irish.csv` — public CSV extract (9,351 rows)
- `irish.json` — public JSON extract (9,351 rows)
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------------- |
| live.irish      | available | $9.99     | $27.99        | 108            | 56     | 4      | name.com         |
| air.irish       | resell    | $31.98    | —             | 84             | 49     | 3      | Spaceship, Inc.  |
| one.irish       | premium   | $500      | $500          | 132            | 50     | 3      | name.com         |
...
| tech.irish      | resell    | —         | —             | 104            | 50     | 4      | Porkbun LLC      |
...
| ----------------------- | ------------------------------------------------ |
| 9,351-row public sample | 9,352 live domains                               |
...
> Unique Domains. *Available .IRISH One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
